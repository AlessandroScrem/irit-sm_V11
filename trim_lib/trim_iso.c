...
IRIT_GLOBAL_DATA CagdRType
    _TrimUVCrvApproxTolSamples = 0.005;
IRIT_GLOBAL_DATA SymbCrvApproxMethodType
    _TrimUVCrvApproxMethod = SYMB_CRV_APPROX_TOLERANCE;
...
* ordered isoparametric values prescribed by OrigIsoParams, in axis Axis.    M
*                                                                            *
* PARAMETERS:                                                                M
...
*                                                                            *
* PARAMETERS:                                                                M
*   UVCrvs:         UV curves to intersect. Must be piecewise linear.        M
*   Dir:            Either U or V.			                     M
