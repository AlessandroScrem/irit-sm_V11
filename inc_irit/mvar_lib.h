...
/* A container to hold a list of either polylines or triangles. */
typedef struct MvarPolyStruct { 
    struct MvarPolyStruct *Pnext;
    union {
	MvarPolylineStruct *PllnList;
	MvarTriangleStruct *TriList;
    } U;
    int PlType;			            /* 0 - Polylines, 1 - Triangles. */
} MvarPolyStruct;
...
/* The general zero finding problem and solution structures. */
...
typedef int (*MvarMVsZerosSubdivCallBackFuncType)(MvarZeroPrblmStruct *, int);
typedef const CagdRType *(*MvarMapPrm2EucCallBackFuncType)(CagdRType *, int);
...
MvarPolyStruct *MvarPolyCopy(const MvarPolyStruct * const Poly);
...
MvarMVsZerosSubdivCallBackFuncType MvarExprTreeZerosSetCallBackFunc(
		       MvarMVsZerosSubdivCallBackFuncType SubdivCallBackFunc);
...
/******************************************************************************
* Routines to handle line sweep over freeform surfaces (flank milling, wire   *
* EDM, hot wire cutting).						      *
******************************************************************************/
