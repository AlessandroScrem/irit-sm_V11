...
IRIT_GLOBAL_DATA IrtVecType GMSphereCoverVectors4[] = {
...
IRIT_GLOBAL_DATA IrtVecType GMSphereCoverVectors20[] = {
...
IRIT_GLOBAL_DATA IrtVecType GMSphereCoverVectors50[] = {
...
IRIT_GLOBAL_DATA IrtVecType GMSphereCoverVectors100[] = {
...
IRIT_GLOBAL_DATA IrtVecType GMSphereCoverVectors130[] = {
...
IRIT_STATIC_DATA IrtVecType
    ...
    *GMSphereCoverVectors = GMSphereCoverVectors4;
...
void GMSphConeSetConeDensity(int n)
{
    ...
    GMSphereCoverVectors = GMSphereCoverVectorsArray[Index];
...
const IrtVecType *GMSphConeGetPtsDensity(int *n)
{
    ...
    *n = SphereCoverLengthArray[Index];
    return (const IrtVecType *) GMSphereCoverVectorsArray[Index];
}
...
VoidPtr GMSphConeQueryInit(IPObjectStruct *PObj)
{
	...
	*SphCone = (GMSphConeStruct *) IritMalloc(sizeof(GMSphConeStruct));
    ...
    for (i = 0, SQC = SphCone -> Cones; i < SphereCoverLength; i++, SQC++) {
        IRIT_PT_COPY(SQC -> Vec, GMSphereCoverVectors[i]);
	Index = 0;
