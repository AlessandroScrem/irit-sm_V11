...
IPObjectStruct *ComputeBeltCurve(IPObjectStruct *Pulleys,
				 ...
				 IrtRType *ReturnCrvs);
IPObjectStruct *CrvCubicApprox(IPObjectStruct *PCrv, IrtRType *Tolerance);
...
IPObjectStruct *SrfLineDist(IPObjectStruct *PSrf,
			    ...
			    IrtRType *SubdivTol,
			    IrtRType *NumerTol);
IPObjectStruct *FreeformComposition(IPObjectStruct *PObj1, IPObjectStruct *PObj2);
...
IPObjectStruct *CurveEnvelopeOffset(IPObjectStruct *CrvObj,
				    IrtRType *Height,
				    IrtRType *Tolerance);
IPObjectStruct *SphericalBisector(IPObjectStruct *Objs, IrtRType *SubdivTol);
...
IPObjectStruct *ComputeCrvMat2D(IPObjectStruct *CrvObj,
				IrtRType *SubdivTol,
				IrtRType *NumericTol);
...
IPObjectStruct *IritCurves2ContactAnal(const IPObjectStruct *Crv1,
				       ...
				       IrtRType *RSubdivTol,
				       IrtRType *RNumericTol);
IPObjectStruct *IritObjectTileFFD(const IPObjectStruct *Obj,
			          const IPObjectStruct *TVObj,
			          IrtRType *UTimes,
			          IrtRType *VTimes,
			          IrtRType *WTimes,
			          IrtRType *FitObj,
