...
#define IP_OBJ_FUNC5		600
#define IP_OBJ_FUNC6		700
#define IP_OBJ_FUNC_OFFSET	200
#define IP_OBJ_FUNC_END		799
...
#define IP_GEN_FUNC		800
#define IP_GEN_FUNC_OFFSET	800
#define IP_GEN_FUNC_END		899
...
#define IP_OPERATORS		1000
#define IP_OPERATORS_OFFSET	1000
#define IP_IS_AN_OPERATOR(Token)	((Token) >= IP_OPERATORS && \
					 (Token) <= IP_TKN_LASTOPER)

#define IP_PRSR_MAX_TOKEN	1200              /* Upper bound for tokens. */
...
IRIT_GLOBAL_DATA_HEADER InptPrsrEvalErrType
    IPGlblEvalError,    /* From EvalTree.*/
    IPGlblParseError;   /* From Parsing. */
