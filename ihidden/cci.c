...
#define IHID_COPY_ORIG_ATTR(Dest, Src) { \
    ...
    AttrSetRefPtrAttrib(&(Dest) -> Attr, "_OrigObj", \
		         AttrGetRefPtrAttrib((Src) -> Attr, "_OrigObj")); \
    AttrSetRefPtrAttrib(&(Dest) -> Attr, "_Uv", \
		         AttrGetRefPtrAttrib((Src) -> Attr, "_Uv")); \
}
...
CagdCrvStruct *CrvCrvIntersections(CagdCrvStruct *Crvs, CagdRType CCITol)
{
	...
	*ActiveCurves = NULL,
	...
	if ((ACrvSplitLst =
		  (CagdPtStruct *) AttrGetRefPtrAttrib(ACrv -> Attr,
						       "_SplitPts")) != NULL) {
					  ...
					  int CrvActive)
{
	...
	*CrvSplits = NULL;
	...
	if (InterPts != NULL) {
	    ...
	    CagdPtStruct
		*ACrvSplitLst = (CagdPtStruct *) 
				AttrGetRefPtrAttrib(ACrv -> Attr, "_SplitPts");
	    ...
	    AttrSetRefPtrAttrib(&ACrv -> Attr, "_SplitPts", ACrvSplitLst);
			...
			CagdCrvStruct **Crv2)
{
    ...
    CagdCrvStruct *Crv2a,
	*UVCrv = AttrGetRefPtrAttrib(Crv -> Attr, "_Uv");
    ...
    *Crv2 = Crv2a -> Pnext;
	...
	AttrSetRefPtrAttrib(&(*Crv1) -> Attr, "_Uv", UVCrv1);
	AttrSetRefPtrAttrib(&(*Crv2) -> Attr, "_Uv", UVCrv2);
