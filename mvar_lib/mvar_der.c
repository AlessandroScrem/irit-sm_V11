...
*                                                                            *
* SEE ALSO:                                                                  M
*   MvarMVDeriveBound, MvarMVDerive, MvarBspMVDerive, MvarBzrMVDeriveScalar  M
*                                                                            *
* KEYWORDS:                                                                  M
...
MvarMVStruct *MvarBzrMVDerive(const MvarMVStruct *MV, MvarMVDirType Dir)
{
	...
	*Indices = (int *) IritMalloc(sizeof(int) * MV -> Dim),
	...
	return MvarBspMVDeriveRational(MV, Dir);
...
*   Then:								     M
* Q(i) = (k - 1) * (P(i+1) - P(i)), i = 0 to k-2.			     V
*   For a Euclidean surface this is the same as MvarBzrMVDerive but for a    M
* rational multivar the returned multivar is not the vector field but simply M
* the derivatives of all the multivar's coefficients, including the weights. M
*                                                                            *
* PARAMETERS:                                                                M
*   MV:        To differentiate.                                             M
*   Dir:       Direction of differentiation. Either U or V.                  M
*                                                                            *
* RETURN VALUE:                                                              M
*   MvarMVStruct *:   Differentiated multi-variate.                          M
*                                                                            *
* SEE ALSO:                                                                  M
*   MvarMVDeriveBound, MvarMVDerive, MvarBspMVDerive, MvarBzrMVDerive,       M
*   MvarBspMVDeriveScalar						     M
*                                                                            *
* KEYWORDS:                                                                  M
*   MvarBzrMVDeriveScalar, derivatives                                       M
*****************************************************************************/
...
*                                                                            *
* SEE ALSO:                                                                  M
*   MvarMVDeriveBound, MvarMVDerive, MvarBspMVDerive, MvarBspMVDerive        M
*   MvarBzrMVDeriveScalar						     M
*                                                                            *
* KEYWORDS:                                                                  M
*   MvarBspMVDeriveScalar, derivatives                                       M
*****************************************************************************/
