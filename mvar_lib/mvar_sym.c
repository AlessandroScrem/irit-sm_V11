...
* operation can take place. Furthermore, order and continuity are	     M
* matched as well.							     M
*                                                                            *
* PARAMETERS:                                                                M
...
/*****************************************************************************
* DESCRIPTION:                                                               M
* Given two multivariates - computes the Z component of the cross product.   M
*   Returned multivariate is a scalar multivariate representing the Z	     M
* component of the cross product of the two given multivariates.	     M
*                                                                            *
* PARAMETERS:                                                                M
*   MV1, MV2:  Two multivariate to multiply and compute a Z component of     M
*              cross product for.					     M
*                                                                            *
* RETURN VALUE:                                                              M
*   MvarMVStruct *:   A scalar multivariate representing the Z component of  M
*                     the cross product of MV1 x MV2.                        M
*                                                                            *
* SEE ALSO:                                                                  M
*   MvarMVDotProd, MvarMVVecDotProd, MvarMVScalarScale, MvarMVMultScalar,    M
*   MvarMVInvert, MvarMVCrossProd, MvarMVCrossProd2D                         M
*                                                                            *
* KEYWORDS:                                                                  M
*   MvarMVCrossProdZ, product, cross product, multivariates,	             M
*   symbolic computation					             M
*****************************************************************************/
MvarMVStruct *MvarMVCrossProdZ(const MvarMVStruct *MV1,
			       const MvarMVStruct *MV2)
{
    MvarMVStruct *MVProdScalars[MVAR_MAX_PT_SIZE],
	*MVProd = MvarMVCrossProd(MV1, MV2);

    /* Extract the Z component, move to X. and free the other two axes. */
    MVAR_SPLIT_SCALARS(MVProd, MVProdScalars);
    MvarMVFree(MVProdScalars[1]);
    MvarMVFree(MVProdScalars[2]);
    MVProdScalars[1] = MVProdScalars[3];
    MVProdScalars[2] = MVProdScalars[3] = NULL;

    /* Constructs the Z component as a scanar MV. */
    MvarMVFree(MVProd);
    MVProd = MvarMVMergeScalar(MVProdScalars);

    MvarMVFree(MVProdScalars[1]);
    if (MVProdScalars[0] != NULL)
        MvarMVFree(MVProdScalars[0]);
...
* SEE ALSO:                                                                  M
*   MvarMVDotProd, MvarMVVecDotProd, MvarMVScalarScale, MvarMVMultScalar,    M
*   MvarMVInvert, MvarMVCrossProd2D, MvarMVCrossProdZ                        M
*                                                                            *
* KEYWORDS:                                                                  M
...
* SEE ALSO:                                                                  M
*   MvarMVDotProd, MvarMVVecDotProd, MvarMVScalarScale, MvarMVMultScalar,    M
*   MvarMVInvert, MvarMVCrossProd, MvarMVCrossProdZ                          M
*                                                                            *
* KEYWORDS:                                                                  M
