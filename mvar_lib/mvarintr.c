...
* computationally when the geometry is complex (i.e. dozens of control       M
* points or more).						             M
*                                                                            *
* PARAMETERS:                                                                M
...
*   NumericTol:   Numeric tolerance of a possible numeric improvement stage. *
				       ...
				       CagdRType NumericTol)
{
    ...
    MvarETUpdateConstDegDomains(MVETs, 2);
    ...
    MVPts = MvarETsZeros0D(MVETs, NULL, 2, SubdivTol, NumericTol);
				       ...
				       CagdRType NumericTol)
{
    ...
    /* Solve the constraints. */
    MVPts = MvarMVsZeros0D(MVs, NULL, 2, SubdivTol, NumericTol);
...
* computationally when the geometry is complex (i.e. dozens of control       M
* points or more, in each directions).				             M
*                                                                            *
* PARAMETERS:                                                                M
...
*   NumericTol:       Numeric tolerance of a possible numeric improvement    M
...
*                                                                            *
* SEE ALSO:                                                                  M
*   MvarCrvCrvInter, MvarSrfSrfContact			                     M
*                                                                            *
* KEYWORDS:                                                                  M
					  ...
					  CagdRType NumericTol)
{
    ...
    /* Solve the constraints. */
    MVPts = MvarETsZeros0D(MVETs, NULL, 6, SubdivTol, NumericTol);
					  ...
					  CagdRType NumericTol)
{
    ...
    /* Solve the constraints. */
    MVPts = MvarMVsZeros0D(MVs, NULL, 6, SubdivTol, NumericTol);
...
*                                                                            *
* SEE ALSO:                                                                  M
*   MvarCrvCrvInter, MvarSrfSrfSrfInter			                     M
*                                                                            *
* KEYWORDS:                                                                  M
*   MvarSrfSrfContact                                                        M
*****************************************************************************/
					 ...
					 CagdRType NumericTol)
{
    ...
    MVPts = MvarETsZeros0D(MVETs, Constraints, 6, SubdivTol, NumericTol);
					 ...
					 CagdRType NumericTol)
{
	...
	*MVs1[4], *MVs2[4], *ScalarMVs[MVAR_MAX_PT_COORD + 1];
	...
	if (SclSplit[0] != NULL && MVs1[0] != NULL) {
	    ...
	    MVs1[0] = MvarPromoteMVToMV2(TMV, 5, 4);
	    MvarMVFree(TMV);
	    MVs1[0] = MvarMVSetAllDomains(MVs1[0], Min, Max, TRUE);
	}
    ...
    MVPts = MvarMVsZeros0D(MVs, Constraints, 6, SubdivTol, NumericTol);
