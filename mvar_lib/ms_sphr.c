						       ...
						       CagdRType NumericTol)
{
	...
	*MVTmp0, *MVTmp1, *MVTmp2;
    ...
    /* Create a multi-linear MVs to represent the center.  This MV will span */
    ...
    MVPts = MvarMVsZeros0D(MVsConstraints, NULL, NumOfConstraints,
			   SubdivTol, NumericTol);
						       ...
						       CagdRType NumericTol)
{
	...
	*MVTmp0, *MVTmp1, *MVTmp2, *MVTmp3;
    ...
    /* Invoke the zero set solver. */
    MVPts = MvarETsZeros0D(MVETsConstraints, NULL,
