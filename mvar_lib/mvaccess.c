...
/*****************************************************************************
* DESCRIPTION:                                                               M
*   Derives the visibility domain of CPosSrf, when accessed from the	     M
* direction that is specified by COrientSrf, not gouging into CCheckSrf.     M
...
*		  surface.  Must be in same function space as CPosSrf.       M
*		  If NULL, the normal field of CPosSrf is employed.	     M
...
*   NumerTol:     Numeric tolerance of a possible numeric improvement stage. M
*		  The numeric stage is employed if NumericTol < SubdivTol.   M
*                                                                            *
* RETURN VALUE:                                                              M
*   MvarPolylineStruct *: The boundary of the accessible regions of CPosSrf. M
*                                                                            *
* KEYWORDS:                                                                  M
				         ...
				         CagdRType NumerTol)
{
    ...
    MvarMVStruct *MVF[4], *MVTmp, *MVSrfCheck, *MVSrf, *MVCheck,
	*MVOrientOrtho1, *MVOrientOrtho2, *MVCheckNrml;
    MvarPtStruct *Pt;
    MvarPolylineStruct *Pl, *Pls;
    ...
    Pls = MvarMVsZeros1D(MVF, NULL, 3, SubdivTol / 10.0, SubdivTol, NumerTol);
				     ...
				     CagdRType NumerTol)
{
	...
	*MVSplitDvSrf[4], **MVSplit, *MVTmp1, *MVTmp2, *MVTmp3, *MVTmp4;
    ...
    Pts = MvarMVsZeros0D(MVConst, NULL, 2, SubdivTol, NumerTol);

#ifdef SILH_INFLECT_FILTER_SINGULAR_SOLS
...
#endif /* SILH_INFLECT_FILTER_SINGULAR_SOLS */
...
*                                                                            *
* RETURN VALUE:                                                              M
*   MvarPolylineStruct *:  Flecnodal curves as polylines in (a, b, u, v)     M
*                          space.					     M
*                                                                            *
* SEE ALSO:                                                                  M
...
{
    int i;
    MvarPolylineStruct *FlecCrv, *Poly;
    MvarPtStruct *Pt;
    MvarMVStruct
	**MVs = MvarFlecnodalCrvsCreateMVCnstrnts(Srf);

    FlecCrv = MvarMVsZeros1D(MVs, NULL, 3, Step, SubdivTol, NumerTol);
				  ...
				  CagdRType NumerTol)
{
	...
	*A4, *AB3, *A2B2, *A3B, *B4, *LinMV,
    ...
    /* Solve the constraints. */
    Pts = MvarMVsZeros0D(MVConst, NULL, 4, SubdivTol, NumerTol);
