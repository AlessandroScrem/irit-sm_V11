...
IRIT_STATIC_DATA MvarErrorStruct ErrMsgs[] =
{
    ...
    { MVAR_ERR_ZER_NUMERIC_TOO_EARLY, IRIT_EXP_STR("Numeric improvement invoked with no topological guarantee.") },
    { MVAR_ERR_ZER_PRBLM_CNSTRCT,  IRIT_EXP_STR("Problem constructing multivar zero finding problem.") },
    { MVAR_ERR_ZER_ORDER_CNSTRCT,  IRIT_EXP_STR("MV zero constraints not in expected order: ZERO, ZERO_SUBDIV, NONZERO.") },
    { MVAR_ERR_ZER_SOL_CNSTRCT,    IRIT_EXP_STR("Problem constructing solution to multivar zero finding problem.") },
    { MVAR_ERR_ZER_SCT_TOO_EARLY,  IRIT_EXP_STR("Single Component Test for surfaces invoked before No Bubbles guaranteed.") },
    { MVAR_ERR_ZER_GZT_TOO_EARLY,  IRIT_EXP_STR("Genus Zero Test for surfaces invoked before Single Component guaranteed.") },
    { MVAR_ERR_TWO_SAME_MVS,       IRIT_EXP_STR("Two identical multivariate were given.  Expected different multivariates.") },
    { MVAR_ERR_ZER_SINGULAR_SOLS,  IRIT_EXP_STR("Some constraints are identically zero - system is singular.") },
