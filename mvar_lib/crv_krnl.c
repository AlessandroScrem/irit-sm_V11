...
*                                                                            *
* RETURN VALUE:                                                              M
*   MvarPolylineStruct *:   The silhouettes along the third, t, parameter    M
*			    of the trivariate function f(u, v, t).	     M
*                                                                            *
* SEE ALSO:                                                                  M
					    ...
					    CagdRType NumEps)
{
    ...
    MVPllns = MvarMVsZeros1D(MVVec, NULL, 2, SubEps / 10.0, SubEps, NumEps);
    MvarMVFree(MVVec[0]);
    MvarMVFree(MVVec[1]);
...
* connects two points on the curve orthogonally to the curve.		     M
				...
				CagdRType NumEps)
{
	...
	*ObjPtList = IPGenLISTObject(NULL);
    ...
    MvarMVFree(MVTmp2);
    MVPts = MvarMVsZeros0D(MVVec, NULL, 2, SubEps, NumEps);
    MvarMVFree(MVVec[0]);
    MvarMVFree(MVVec[1]);
