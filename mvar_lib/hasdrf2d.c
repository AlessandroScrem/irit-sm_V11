					  ...
					  CagdRType Epsilon)
{
	...
	*MVs[4];
	...
	AntiPodalPoints = MvarMVsZeros0D(MVs, Constrs, 4,
	...
	AntiPodalPoints = MvarMVsZeros0D(MVs, NULL, 2,
				         MVAR_HF_DIST_SUBDIV_TOL, Epsilon);
    }
							  ...
							  CagdRType Epsilon)
{
	...
	*PPList = NULL;
    ...
    for (Crv1a = Crv1Segs; Crv1a != NULL; Crv1a = Crv1a -> Pnext) {
	    ...
	    IPt = MvarMVsZeros0D(MVs, NULL, 3, MVAR_HF_DIST_SUBDIV_TOL,
			         -Epsilon);
...
*                                                                            *
* RETURN VALUE:                                                              M
*   MvarMVStruct *: Factored out 3-variate, (rep. as a multivariate).        M
*                                                                            *
* SEE ALSO:                                                                  M
						   ...
						   CagdRType Epsilon)
{
	...
	*PPList = NULL;
	...
	InterPts = MvarETsZeros0D(MVETs, NULL, 3,
				  MVAR_HF_DIST_SUBDIV_TOL, Epsilon);
	...
	InterPts = MvarMVsZeros0D(MVs, NULL, 3, MVAR_HF_DIST_SUBDIV_TOL,
				  -Epsilon);
