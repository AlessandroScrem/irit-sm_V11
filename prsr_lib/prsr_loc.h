...
typedef enum {
    ...
    IGS_ENTYPE_PLANE_SRF = 190,
    IGS_ENTYPE_RGT_CIRC_CYLIN_SRF = 192,
    IGS_ENTYPE_RGT_CIRC_CONE_SRF = 194,
    IGS_ENTYPE_SPHERE_SRF = 196,
    IGS_ENTYPE_TORUS_SRF = 198,
    ...
    IGS_ENTYPE_VERTEX_ENTITY = 502,
    IGS_ENTYPE_EDGE_ENTITY = 504,
    IGS_ENTYPE_LOOP_ENTITY = 508,
    IGS_ENTYPE_FACE_ENTITY = 510,
    IGS_ENTYPE_SHELL_ENTITY = 514
} IgesEntryType;
...
typedef enum {
    ...
    IGS_IRT_OP_SPHERE,
    IGS_IRT_OP_TORUS,
    IGS_IRT_OP_PLANE_SRF,
    IGS_IRT_OP_RGT_CYL_SRF,
    IGS_IRT_OP_RGT_CONE_SRF,
    IGS_IRT_OP_SPHERE_SRF,
    IGS_IRT_OP_TORUS_SRF,
