...
typedef struct IPNCGCodeStreamStruct {
    ...
    IPNCGCodeIndexUpdateFuncType GCodeIndexUpdateFunc;
...
/*****************************************************************************
* DESCRIPTION:                                                               M
*   Sets a call back function to be invoked on every G code index change in  M
* the simulation.							     M
*                                                                            *
* PARAMETERS:                                                                M
*   IPNCGCodes:  G Code sequence to traverse.                                M
*   Func:        New call back function to use or NULL to disable.           M
*                                                                            *
* RETURN VALUE:                                                              M
*   IPNCGCodeIndexUpdateFuncType:  Old call back function.                   M
*                                                                            *
* SEE ALSO:                                                                  M
*   IPNCGCodeTraverseInit                                                    M
*                                                                            *
* KEYWORDS:                                                                  M
*   IPNCGCodeUpdateGCodeIndexCBFunc                                          M
*****************************************************************************/
				           ...
				           IPNCGCodeIndexUpdateFuncType Func)
{
    ...
    IPNCGCodeStreamStruct
	*GCS = (IPNCGCodeStreamStruct *) IPNCGCodes;
    IPNCGCodeIndexUpdateFuncType
        OldVal = GCS -> GCodeIndexUpdateFunc;

    GCS -> GCodeIndexUpdateFunc = Func;
    return OldVal;
}
				     ...
				     int Forward)
{
    ...
    if (GCS -> GCodeIndexUpdateFunc != NULL)
        GCS -> GCodeIndexUpdateFunc();
