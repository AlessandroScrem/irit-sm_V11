...
IRIT_STATIC_DATA IPErrorStruct IPGlblErrMsgs[] =
{
    ...
    { IP_ERR_ONLY_FREEFORM,	IRIT_EXP_STR("Only curve/surface/trisrf/trivariate/multivariate expected.") },
    { IP_ERR_ONLY_CRV_SRF_MV,	IRIT_EXP_STR("Only curve/surface/multivar expected") },
    { IP_ERR_ONLY_TRI_SRF,	IRIT_EXP_STR("Only triangular surface expected") },
    { IP_ERR_ONLY_TRIM_SRF,	IRIT_EXP_STR("Only trimmed surfaces expected") },
    { IP_ERR_CNVRT_TO_PERIODIC, IRIT_EXP_STR("Conversion to periodic is not supported") },
    { IP_ERR_CNVRT_PER_TO_FLOAT,IRIT_EXP_STR("Conversion to float legal only from periodic") },
    { IP_ERR_CNVRT_BSP_TO_FLOAT,IRIT_EXP_STR("Conversion to float legal only from B-spline rep.") },
    { IP_ERR_CNVRT_MV_NOT_UNIVAR,IRIT_EXP_STR("Multivariate is not a bivariate") },
    { IP_ERR_CNVRT_MV_NOT_BIVAR,IRIT_EXP_STR("Multivariate is not a trivariate") },
    { IP_ERR_CNVRT_MV_NOT_TRIVAR,IRIT_EXP_STR("Multivariate is not a univariate") },
    { IP_ERR_CNVRT_TSRF_TO_MDL,	IRIT_EXP_STR("Only a (trimmed) surface can be coerced into a model") },
    { IP_ERR_CNVRT_SRF_MDL_TO_TSRF,IRIT_EXP_STR("Only a surface or a model may be coerced into a trimmed surface") },
    { IP_ERR_CNVRT_INVALID_GEOM_TO_MV,IRIT_EXP_STR("Invalid source geometry for coercion to multivariate") },
    { IP_ERR_CNVRT_INVALID_COERCE,IRIT_EXP_STR("Invalid coercion requested.") },
};
