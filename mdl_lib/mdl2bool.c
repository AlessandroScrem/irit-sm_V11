...
#   ifdef DEBUG_MDL_DUMP_MERGE_TRIM_CRVS
	...
	MdlDebugHandleTSrfRefCrvs(*Refs, TSrf, NULL, 1, FALSE, FALSE);
	MdlDebugHandleTSrfRefCrvs(*Refs, TSrf, NULL, 1, TRUE, FALSE);
...
#   ifdef DEBUG_MDL_DUMP_MERGE_TRIM_CRVS
	...
	MdlDebugHandleTCrvLoops(NULL, Loops, NULL, FALSE, FALSE);
#   endif /* DEBUG_MDL_DUMP_MERGE_TRIM_CRVS */
