...
static void MdlBoolCorrectCrvEndPt(const MdlTrimSegStruct *Seg,
				   ...
				   CagdRType Eps);
static MdlTrimSegStruct *MdlBoolGenTrimSegs(const MvarPolylineStruct *Inters12,
...
*                                                                            *
* PARAMETERS:                                                                M
*   SubdivTol, NumerTol, TraceTol:    See MvarSrfSrfInter.                   M
*                                                                            *
* RETURN VALUE:                                                              M
*   void                                                                     M
*                                                                            *
    ...
    for (TSrf1 = CpModel1 -> TrimSrfList;
	 ...
	 TSrf1 = TSrf1 -> Pnext) {
        for (TSrf2 = CpModel2 -> TrimSrfList;
	     ...
	     TSrf2 = TSrf2 -> Pnext) {
	    MvarPolylineStruct
	        *Inters12 = MvarSrfSrfInter(TSrf1 -> Srf, TSrf2 -> Srf,
					    GlblMdlBoolTraceTol,
