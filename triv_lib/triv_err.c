...
IRIT_STATIC_DATA TrivErrorStruct ErrMsgs[] =
{
    ...
    { TRIV_ERR_BZR_TV_EXPECT,	IRIT_EXP_STR("Bezier trivariate is expected") },
    ...
    { TRIV_ERR_CRV_OR_SRF_EXPECTED,IRIT_EXP_STR("A curve or a surface expected") },
...
/*****************************************************************************
* DESCRIPTION:                                                               M
* Returns a string describing the given error. Errors can be raised by       M
