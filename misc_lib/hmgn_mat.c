...
*   MatRes = Mat1 * Mat2 assumed Mat[i][j] refers to row i and column j.     M
...
*                                                                            *
* SEE ALSO:                                                                  M
*   MatRotateFactorMatrix, MatTranslateFactorMatrix, MatRotSclFactorMatrix   M
*                                                                            *
* KEYWORDS:                                                                  M
...
*                                                                            *
* SEE ALSO:                                                                  M
*   MatScaleFactorMatrix, MatTranslateFactorMatrix, MatRotSclFactorMatrix    M
*                                                                            *
* KEYWORDS:                                                                  M
...
/*****************************************************************************
* DESCRIPTION:                                                               M
* Routine to estimate the rotation and scale factors in a matrix.            M
*                                                                            *
* PARAMETERS:                                                                M
*   M:          Matrix to extract rotation and scale factors from.           M
*   RotSclMat:  The rotation and scale factors of matrix M.		     M
*                                                                            *
* RETURN VALUE:                                                              M
*   void		                                                     M
*                                                                            *
* SEE ALSO:                                                                  M
*   MatScaleFactorMatrix, MatRotateFactorMatrix, MatTranslateFactorMatrix    M
*                                                                            *
* KEYWORDS:                                                                  M
*   MatRotSclFactorMatrix, transformations		                     M
*****************************************************************************/
void MatRotSclFactorMatrix(IrtHmgnMatType M, IrtHmgnMatType RotSclMat)
{
    IRIT_HMGN_MAT_COPY(RotSclMat, M);

    /* Mask out the translation factor. */
    RotSclMat[3][0] = RotSclMat[3][1] = RotSclMat[3][2] = 0.0;
}
