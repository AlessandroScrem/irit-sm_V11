...
*   Pt:           A point on the unit sphere, on the northern hemisphere.    M
*   CCrv:         A curve on the unit sphere, on the northern hemisphere.    M
*   SubdivTol:    Accuracy of piecewise linear approximation.		     M
*                                                                            *
* RETURN VALUE:                                                              M
					...
					CagdRType SubdivTol)
{
	...
	*BisectCrv = SymbPtCrvBisectOnSphere(Pt, CCrv);
    CagdPolylineStruct
	*BisectPoly = SymbCrv2Polyline(BisectCrv, SubdivTol,
				       SYMB_CRV_APPROX_TOLERANCE, FALSE);
					 ...
					 CagdRType SubdivTol)
{
	...
	*PLCrvList = NULL;
    ...
    Cntrs = UserCntrSrfWithPlane(BisectSrf, Plane, SubdivTol, TRUE);
