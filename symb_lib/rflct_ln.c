			...
			const char *AttribName)
{
	...
	*TSrf3 = SymbSrfDotProd(Srf, TSrf2);
    ...
    AttrSetRefPtrAttrib(&Srf -> Attr, Name, TSrf3);
    sprintf(Name, "%sRHS", AttribName);
    AttrSetRefPtrAttrib(&Srf -> Attr, Name, TSrf2);
}
			      ...
			      const char *AttribName)
{
    ...
    sprintf(Name, "%sLHS", AttribName);
    LHSSrf = (CagdSrfStruct *) AttrGetRefPtrAttrib(Srf -> Attr, Name);
    sprintf(Name, "%sRHS", AttribName);
    RHSSrf = (CagdSrfStruct *) AttrGetRefPtrAttrib(Srf -> Attr, Name);
...
void SymbRflctLnFree(CagdSrfStruct *Srf, const char *AttribName)
{
    ...
    sprintf(Name, "%sLHS", AttribName);
    if ((TSrf = (CagdSrfStruct *) AttrGetRefPtrAttrib(Srf -> Attr,
						      Name)) != NULL)
        CagdSrfFree(TSrf);
			  ...
			  const char *AttribName)
{
	...
	*RefDirSqr = SymbSrfDotProd(RefDir, RefDir);
    ...
    AttrSetRefPtrAttrib(&Srf -> Attr, AttribName, TSrf1);
}
				...
				const char *AttribName)
{
    ...
    TSrf1 = (CagdSrfStruct *) AttrGetRefPtrAttrib(Srf -> Attr, AttribName);
    if (TSrf1 == NULL) {
        SymbRflctCircPrepSrf(Srf, ViewDir, SprCntr, AttribName);

	TSrf1 = (CagdSrfStruct *) AttrGetRefPtrAttrib(Srf -> Attr,
						      AttribName);
    }
			    ...
			    const char *AttribName)
{
	...
	*TSrf2 = SymbSrfVecCrossProd(TSrf1, LnDir);
    ...
    AttrSetRefPtrAttrib(&Srf -> Attr, AttribName, TSrf2);
}
				  ...
				  const char *AttribName)
{
    ...
    RHSSrf = (CagdSrfStruct *) AttrGetRefPtrAttrib(Srf -> Attr, AttribName);
    if (RHSSrf == NULL) {
        SymbHighlightLnPrepSrf(Srf, LnDir, AttribName);

	RHSSrf = (CagdSrfStruct *) AttrGetRefPtrAttrib(Srf -> Attr,
						       AttribName);
    }
