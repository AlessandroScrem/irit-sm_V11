...
OBJS =  adap_iso.o arc_len.o biarc.o blending.o bspkntrm.o bsp3injc.o \
	...
	compost2.o constrct.o crv_lenv.o crv_skel.o crv_tans.o \
	crvtrrec.o cubcaprx.o curvatur.o decompos.o \
	distance.o duality.o evalcurv.o ffptdist.o moffset.o moments.o \
	morphing.o multires.o nrmlcone.o \
	offset.o orthotom.o prm_dmn.o prisa.o rflct_ln.o rrinter.o rvrs_eng.o \
	smp_skel.o symb_cci.o symb_crv.o symb_err.o symb_ftl.o \
