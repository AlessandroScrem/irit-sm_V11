...
*   C1, C2:      The two curves forming the first ruled surface.             M
*   D1, D2:      The two curves forming the second ruled surface.            M
*   SubdivTol:   Accuracy of zero set computation as part of the solution.   M
*                Value of 0.01 is a good start.  If SubdivTol is negative    M
*		 the ruled surfaces are assumed infinite (and absolute value M
*		 of SubdivTol is employed).  Otherwise, the ruled surface is M
					  ...
					  CagdCrvStruct **PCrvs2)
{
    ...
    CagdBType
	InfiniteRuledSrfs = SubdivTol < 0.0;
...
#   endif /* NO_RRI_TRIVIAL_REJECT */
    ...
    Cntrs = UserCntrSrfWithPlane(TSrf, Plane, SubdivTol, TRUE);
    CagdSrfFree(TSrf);
...
*	         integral curves.					     M
*   SubdivTol:   Accuracy of zero set computation as part of the solution.   M
*                Value of 0.01 is a good start.				     M
*   PCrvs1, PCrvs2:  The parametric domains of the intersection curves, in   M
*		 the two surfaces.					     M
*                                                                            *
* RETURN VALUE:                                                              M
