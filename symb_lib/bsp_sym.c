...
*                                                                            *
* PARAMETERS:                                                                M
*   BspMultMethod:      See BspMultComputationMethodType. Bspline product is M
8                       computed by either Bezier decomposition, or setting  M
*                       an interpolation problem, or using Blossoming.       M
*                                                                            *
* RETURN VALUE:                                                              M
*   BspMultComputationMethodType:    Previous setting.                       M
*                                                                            *
* KEYWORDS:                                                                  M
				   ...
				   BspMultComputationMethodType BspMultMethod)
{
    BspMultComputationMethodType
        PrevSetting = BspMultComputeMethod;

    BspMultComputeMethod = BspMultMethod;
