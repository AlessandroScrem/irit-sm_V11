...
const SymbNormalConeStruct *SymbNormalConeForSrfAvg(const CagdSrfStruct *Srf)
{
    ...
    int i, MeshSize;
    CagdSrfStruct
	*NrmlSrf = (CagdSrfStruct *) AttrGetRefPtrAttrib(Srf -> Attr,
						         "_NormalSrf");
						  ...
						  CagdVType MainAxis)
{
	...
	*NrmlSrf = (CagdSrfStruct *) AttrGetRefPtrAttrib(Srf -> Attr,
	...
	AttrSetRefPtrAttrib(&((CagdSrfStruct *) Srf) -> Attr, "_NormalSrf",
			    NrmlSrf);
    }
			   ...
			   SymbNormalConeStruct *Cone2)
{
    ...
    NrmlSrf = (CagdSrfStruct *) AttrGetRefPtrAttrib(Srf -> Attr, "_NormalSrf");
    assert(NrmlSrf != NULL);
