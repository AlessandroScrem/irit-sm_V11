...
#define MAX_OFFSET_IMPROVE_ITERS	10
...
{
    int i,
	MultMethod = BspMultComputationMethod(BSP_MULT_BLOSSOMING);
    CagdBType
	...
	*OffsetCrv = NULL;
    ...
    BspMultComputationMethod(MultMethod);
					      ...
					      CagdRType NumerTol)
{
	...
	*DistSqr = SymbSrfDistCrvCrv(OffCrv, Crv, 1);
    ...
    Cntrs = UserCntrSrfWithPlane(DistSqr, Plane, SubdivTol, TRUE);
