...
{
    { SYMB_ERR_WRONG_INPUT,		IRIT_EXP_STR("Provided input is wrong") },
    ...
    { SYMB_ERR_INVALID_CRV,		IRIT_EXP_STR("Invalid curve") },
    { SYMB_ERR_INVALID_SRF,		IRIT_EXP_STR("Invalid surface") },
