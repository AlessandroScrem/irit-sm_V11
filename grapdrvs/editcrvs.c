...
*   MenuIndex:   Index of last pop up menu event, if any.  Integer of a size M
*                that can represent a pointer.				     M
*                                                                            *
* RETURN VALUE:                                                              M
*   void                                                                     M
*                                                                            *
...
*****************************************************************************/
void CEditHandleNonMouseEvents(IGCrvEditEventType Event,
			       IritIntPtrSizeType MenuIndex)
{
    IRIT_STATIC_DATA int
...
/*****************************************************************************
* DESCRIPTION:                                                               M
*   Detach for the currently edited curve.                                   M
*                                                                            *
* PARAMETERS:                                                                M
*   None                                                                     M
*                                                                            *
