...
static void ActivatePopupMenu(Widget Parent,
			      ...
			      char *Title,
			      XTC CallBackFunc,
			      IritIntPtrSizeType RelSelectIndex,
			      int RelX,
			      int RelY);
...
*   CallBackFunc:  Specifies the call back function.                         *
*   RelSelectIndex: Argument to pass to the call back funcion.               *
*                Of size that can carry a pointer.			     *
