...
IRIT_STATIC_DATA CagdRType GlblCagdCubePSpherePatchCtlpts[16][3] = {
    {  0.57744324793724,  0.57744324793724, -0.57744324793724 },
    {  0.2325472380749,   0.75032795893632, -0.75032795893632 },
    { -0.2325472380749,   0.75032795893632, -0.75032795893632 },
    { -0.57744324793724,  0.57744324793724, -0.57744324793724 },

    {  0.75032795893632,  0.2325472380749,  -0.75032795893632 },
    {  0.341,             0.341,            -1.214 },
    { -0.341,             0.341,            -1.214 },
    { -0.75032795893632,   0.2325472380749, -0.75032795893632 },
...
* DESCRIPTION:                                                               M
*   A surface constructor of a sphere, centered at Center and radius Radius. M
* Constructs the rational sphere out of six patches in a cube topology.	     M
				     ...
				     CagdBType Rational)
{
    int i, n;
    CagdRType **Pts;
    CagdSrfStruct *Srf1, *Srf2, *Srf3, *Srf4, *Srf5, *Srf6;
	...
	for (n = 0; n < 25; n++)
        ...
        Srf1 = BzrSrfNew(4, 4, CAGD_PT_E3_TYPE);
        Pts = Srf1 -> Points;

	/* Copy the hardcoded mesh into the sphere. */
	for (n = 0; n < 16; n++)
	    for (i = 1; i <= 3; i++)
	        Pts[i][n] = GlblCagdCubePSpherePatchCtlpts[n][i - 1];
    }
