...
/*****************************************************************************
* DESCRIPTION:                                                               M
*   Examines the cntrol polygon at given parametric location for a real C1   M
* discontinuity, in Euclidean space.					     M
*                                                                            *
* PARAMETERS:                                                                M
*   Crv:        Curves to examine for a C1 discontinuity.                    M
*   t:          Parameter value to examine at.                               M
*                                                                            *
* RETURN VALUE:                                                              M
*   CagdBType:  TRUE if Crv has a C1 discontinuity at parameter t,	     M
*               FALSE otherwise.		                             M
*                                                                            *
* SEE ALSO:                                                                  M
			      ...
			      CagdRType t)
{
	...
	*KV = Crv -> KnotVector;
    ...
    return !BspCrvMeshC1Continuous(Crv, IndxFirst - 1, NULL);
}
