			     ...
			     IPVertexStruct *E2V2)
{
    ...
    IRIT_STATIC_DATA AttribNumType /* Persistent store to unique Attrs IDs. */
        AttrUVVvalsID = ATTRIB_NAME_BAD_NUMBER;
    float *E1UV1, *E1UV2, *E2UV1, *E2UV2;

    IP_ATTR_INIT_UNIQUE_ID_NUM(AttrUVVvalsID, "uvvals");

    E1UV1 = AttrGetUVAttrib2(E1V1 -> Attr, AttrUVVvalsID);
    E1UV2 = AttrGetUVAttrib2(E1V2 -> Attr, AttrUVVvalsID);
    E2UV1 = AttrGetUVAttrib2(E2V1 -> Attr, AttrUVVvalsID);
    E2UV2 = AttrGetUVAttrib2(E2V2 -> Attr, AttrUVVvalsID);
...
static int IsEdgeOnSrfBndry(IPVertexStruct *V1, IPVertexStruct *V2)
{
    ...
    UV1 = AttrGetUVAttrib2(V1 -> Attr, AttrUVVvalsID);
    UV2 = AttrGetUVAttrib2(V2 -> Attr, AttrUVVvalsID);
