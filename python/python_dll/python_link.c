...
/*****************************************************************************
* DESCRIPTION:                                                               M
*   Gets the volume of the given trivariate.			             M
*                                                                            *
* PARAMETERS:                                                                M
*   TVObj:      Trivariate to compute its volume.			     M
*   VolType:    Volume computation way.					     M
*                                                                            *
* RETURN VALUE:                                                              M
*   double:    The volume.     		                           	     M
*                                                                            *
* KEYWORDS:                                                                  M
*   IritPyIritPyEvalTrivarVolume                                             M
*****************************************************************************/
double IritPyEvalTrivarVolume(IPObjectStruct *TVObj, int VolType)
{
    IrtRType
	R = VolType;

    return EvalTrivarVolume(TVObj, &R);
}
