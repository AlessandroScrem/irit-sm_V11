...
#   endif /* DEBUG */
	...
	case IP_OPERATORS:
		...
		case IP_TKN_NUMBER:
		    ...
		    else if (Root -> PObj -> U.R == (double) IP_COERCE_BEZIER_TYPE)
		        strcat(Str, IRITPY_PREFIX "BEZIER_TYPE");
		    else if (Root -> PObj -> U.R == (double) IP_COERCE_BSPLINE_TYPE)
		        strcat(Str, IRITPY_PREFIX "BSPLINE_TYPE");
		    else if (Root -> PObj -> U.R == (double) IP_COERCE_POWER_TYPE)
		        strcat(Str, IRITPY_PREFIX "POWER_TYPE");
		    else if (Root -> PObj -> U.R == (double) IP_COERCE_GREGORY_TYPE)
