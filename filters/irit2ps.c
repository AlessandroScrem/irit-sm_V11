...
int main(int argc, char **argv)
{
	...
	*PGlblBbox = NULL;
    ...
    if (GlblDepthCue || GlblDepthCueGray) {
	...
	if (IRIT_APX_EQ(GlblDepthCueZ[0], GlblDepthCueZ[1])) {
	    IRIT_INFO_MSG_PRINTF("Warning: Z min equal Z max - depth cue disabled\n");
	    GlblDepthCue = GlblDepthCueGray = FALSE;
	}
	else {
