...
IRIT_STATIC_DATA UserErrorStruct ErrMsgs[] =
{
    ...
    { USER_ERR_INVALID_TRIM_SRF,	IRIT_EXP_STR("Wrong trimmed surface prescribed") },
    { USER_ERR_INVALID_DIR,		IRIT_EXP_STR("Wrong direction prescribed") },
    { USER_ERR_INVALID_IMAGE_SIZE,	IRIT_EXP_STR("Wrong image(s) size") },
    { USER_ERR_INVALID_KV_END_COND,	IRIT_EXP_STR("Wrong freeform's knots end conditions (needs Open EC!?)") },
    { USER_ERR_XRANGE_EMPTY,		IRIT_EXP_STR("X range is empty in given arrangement") },
    { USER_ERR_YRANGE_EMPTY,		IRIT_EXP_STR("Y range is empty in given arrangement") },
    { USER_ERR_ZRANGE_EMPTY,		IRIT_EXP_STR("Z range is empty while a 3D arrangement is configured") },
